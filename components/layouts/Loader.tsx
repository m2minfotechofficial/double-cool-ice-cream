    ...
    return (
        <div className='loader h-screen w-full fixed top-0 left-0 z-50'>
            <div className="h-screen flex items-center justify-center logo-container absolute inset-0 z-20">
                <Image src="/images/logo/loader-logo1.png" style={{ clipPath: "polygon(0% 100%, 100% 100%, 100% 100%, 0% 100%)" }} alt="shop now" width={500} height={500} id="logo" className="opacity-0 w-auto md:h-50 h-30 relative" />
