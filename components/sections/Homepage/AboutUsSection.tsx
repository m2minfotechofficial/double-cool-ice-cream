            ...
            <div className="max-w-7xl grid lg:grid-cols-2 gap-10 lg:gap-5 items-center mx-auto">
                ...
                <div className="relative order-1 lg:order-2">
                    ...
                    <div className="text-center lg:text-left mt-16 md:mt-20">
                        {/* Button */}
                        <Link href="/shop" className="inline-flex items-center justify-center font-bold text-white 2xl:text-2xl xl:text-2xl md:text-lg text-sm rounded-2xl hover:shadow-[5px_5px_0px_rgba(0,0,0)] hover:scale-105 transition-all duration-300 bg-[#892D1C] ps-2 pe-4 lg:pe-5 py-2 lg:py-2.5 font-baloo2">
